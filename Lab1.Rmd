...
4.   Subset the data set to include only data from the high-density site at 8m height. Calculate the minimum, maximum, and average radiometric land surface temperature for this data only.  
  
Save the script as 'lastname_lastname_lab1.R' in your lab1 folder on the network by next Wednesday. 
